      ...
      <div class="p-page__head">
        ...
        <div class="p-head">
          ...
          <div class="p-page__head--action">
            <a class="c-button--text is-current">個人評価</a>
            <a href="{{ route('master.organization-assessment.index') }}">組織評価</a>
            <a href="{{ route('master.personal-assessment.check') }}">個人チェック評価</a>
          </div>
          <div class="action">
            <a href="{{ route('master.personal-assessment.add') }}" class="c-button--add">
                ...
                <tbody>
                  {{--  @foreach($selfCheckSheets as $selfCheckSheet)  --}}
                    <tr>
                      ...
                      <td>
                        <div class="item row">
                          <a href="{{ route('master.personal-assessment.edit') }}" class="c-button--text">編集</a>
                          <a href="{{ route('master.personal-assessment.copy') }}" class="c-button--text">複製</a>
