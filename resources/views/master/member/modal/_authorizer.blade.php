<div class="remodal p-modal" data-remodal-id="modal_authorizer" data-remodal-options="hashTracking: false, closeOnOutsideClick: false">
  ...
  <div class="p-modal__body">
        ...
        <tbody>
          @for($tableBody = 0; $tableBody < 20; $tableBody++)
            <tr>
              <!-- チェックボックス -->
              <td><div class="item">
                <label for="check_authorizer{{ $tableBody }}">
                  <input type="checkbox" id="check_authorizer{{ $tableBody }}" name="check[]" class="check" value="">
                </label>
              </div></td>
              <!-- 氏名 -->
              <td><div class="item">
    ...
    <div class="p-formBlock__action">
      ...
      <button class="c-button c-button--brandPrimary u-w160">承認者を登録</button>
    </div>
  </div>
</div>