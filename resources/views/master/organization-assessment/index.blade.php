  ...
  <div class="l-index">
    <div class="p-page p-page--selfCheck">
      <div class="p-page__head">
        <!-- ページタイトル -->
        <div class="p-head">
          <p class="title">定期評価マスタ</p>
          <div class="p-page__head--action">
            <a href="{{ route('master.personal-assessment.index') }}">個人評価</a>
            <a class="c-button--text is-current">組織評価</a>
            <a href="{{ route('master.personal-assessment.check') }}">個人チェック評価</a>
          </div>
          <div class="action">
            <a href="{{ route('master.organization-assessment.add') }}" class="c-button--add">
                ...
                <tbody>
                  {{--  @foreach($selfCheckSheets as $selfCheckSheet)  --}}
                    <tr>
                      ...
                      <td>
                        <div class="item row">
                          <a href="{{ route('master.organization-assessment.edit') }}" class="c-button--text">編集</a>
                          <a href="{{ route('master.organization-assessment.copy') }}" class="c-button--text">複製</a>
