<div
  ...
  data-remodal-id="modal_commentForm_{{ $self_check_rating_detail->self_check_sheet_item_id }}"
...
>
  ...
  <div class="p-modal__body">
    <div class="p-inputField">
      ...
      <textarea
        id="self_check_sheet_item_comment_{{ $self_check_rating_detail->self_check_sheet_item_id }}"
        placeholder="コメントを記入してください。"
      >{{ $self_check_rating_detail->comment }}</textarea>
    </div>
    <div class="u-pd20"></div>
    <div class="p-formBlock__action">
      <a
        data-remodal-action="close"
        data-id="{{ $self_check_rating_detail->self_check_sheet_item_id }}"
