...
<div class="l-index__split">
  ...
  <div class="p-page">
    <div class="p-page__head u-align u-gap40">
      <h1 class="p-page__head--title">個人チェック評価</h1>
      <div class="p-page__head--action">
        <a href="{{ route('personal-assessment.index') }}" class="c-button--text is-current">個人評価</a>
        <a href="{{ route('personal-assessment.check') }}" class="c-button--text">個人チェック評価</a>
      </div>
    </div>
        ...
        <div class="c-tab__head">
          <a
            class="
              ...
              @endif
            "
            href="{{ route('personal-assessment.index') }}"
          >
          ...
          <a
            class="c-tab__btn c-tab--03
              ...
              @endif
            "
            href="{{ route('personal-assessment.index', ['type' => 'confirm']) }}"
          >
          ...
          @switch($type)
            @case("answer")
              <div class="c-tab__content is-display">
                @include('personal-assessment.components._sheet1')
              </div>
            @break
            @case("rating")
              <div class="c-tab__content is-display">
                @include('personal-assessment.components._sheet2')
              </div>
            @break
            @case("confirm")
              <div class="c-tab__content is-display">
                @include('personal-assessment.components._sheet3')
              </div>
            @break
          @endswitch
        </div>
