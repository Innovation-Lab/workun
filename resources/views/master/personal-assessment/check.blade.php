      ...
      <div class="p-page__head">
        ...
        <div class="p-head">
          ...
          <div class="p-page__head--action">
            ...
            <a class="c-button--text is-current"">個人チェック評価</a>
          </div>
          <div class="action">
                ...
                <tbody>
                  {{--  @foreach($selfCheckSheets as $selfCheckSheet)  --}}
                    <tr>
                      ...
                      <td>
                        <div class="item row">
                          <a href="{{ route('master.self-check.edit', 1) }}" class="c-button--text">編集</a>
                          <a href="{{ route('master.self-check.copy', 1) }}" class="c-button--text">複製</a>
